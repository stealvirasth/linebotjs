      ...
      return client.replyMessage(
        replyToken,
        {
          ...
          template: {
            ...
            columns: [
              {
                imageUrl: 'https://scontent.fbkk3-3.fna.fbcdn.net/v/t1.0-9/fr/cp0/e15/q65/41734949_2150286691918527_7596291142111461376_n.jpg?_nc_cat=103&efg=eyJpIjoidCJ9&_nc_eui2=AeE_fRhAfljp3XPypkiigp86lzGPU2-FCNIDV-Ozku7B_BNCAhCx7cC17RZCAJgCn4Mgo5PuqHJBtj6FXZDUMhhi1y-e7TfknoBkgG-7raID8l6kFcbfjQSDLEbOPlS70j4&_nc_ht=scontent.fbkk3-3.fna&oh=2ae285e74d524c2c96ba8f6cf4b73245&oe=5C729390',
      ...
      return client.replyMessage(
        replyToken,
        {
          ...
          template: {
            type: 'buttons',
            thumbnailImageUrl: 'https://scontent.fbkk3-1.fna.fbcdn.net/v/t1.0-9/fr/cp0/e15/q65/46712297_268191354043365_6515432230884474880_o.jpg?_nc_cat=108&efg=eyJpIjoidCJ9&_nc_eui2=AeFBKosEdXXzVuVQ7i3PhJ9cP2SQmdzqMahrdjead-A9FIZ6qgEO-hadW0mEEcU4lmKyI5BS7a6VWJWqp4O5Q-pHmpYE39ONlrLKKeNcaYOf6IIusOVe5yq3hRfFDgFkou0&_nc_ht=scontent.fbkk3-1.fna&oh=b957cae8fc99007b9957c76e70013a9d&oe=5CB17C45',
            title: 'My button Help',
            text: 'Hello My Friend',
            actions: [
              { label: 'Go to line.me', type: 'uri', uri: 'https://line.me/ti/p/~api_2001' },
              { label: 'Confirm', type: 'message', text: '!confirm' },
              { label: 'Buttons', type: 'message', text: '!buttons' },
              { label: 'Carousel', type: 'message', text: '!carousel' },
              { label: 'Image carousel', type: 'message', text: '!image carousel' },
            ],
          },
        }
      );      
