...
function handleEvent(event) {
  ...
  switch (event.type) {
    ...
    case 'follow':
      return replyText(event.replyToken, 'ขอบคุณที่เป็นเพื่อนแน็ค');
        ...
        replyToken,
        {
          ...
          template: {
            ...
            actions: [
              ...
              { label: 'สวัสดีบอท', type: 'postback', data: 'สวัสดีครับ..!' },
              { label: 'Hello', type: 'postback', data: 'สวัสดีนะ..', text: 'สวัสดี~~~' },
              { label: 'ผู้สร้าง Template', type: 'message', text: '[ แน็ค ] [Magicavi]' },
              { label: 'Facebook',  type: 'message', data: '!facebook'}, 
            ],
          },
        }
      );
            ...
            columns: [
              {
                ...
                text: 'FB: น้อง อิม',
                actions: [
                  { label: 'Facebook', type: 'uri', uri: 'm.facebook.com/phattranit.boonkhong.3' },
                  { label: 'ชื่อ Facebook', type: 'postback', data: 'Phattranit Boonkhong' },
                ],
              },
              {
                thumbnailImageUrl: buttonsImageURL,
                ...
                text: 'FB: BB13X',
                actions: [
                  { label: 'Facebook', type: 'uri', uri: 'm.facebook.com/profile.php?id=100013928628555&ref=content_filter' },
                  { label: 'ชื่อ Facebook', type: 'postback', data: 'Chatmongkol Siangeak' },
                ],
              },
            ],
          },
