        ...
        replyToken,
        {
          ...
          template: {
            ...
            actions: [
              ...
              { label: 'Template', type: 'message', text: 'Help Template' },
            ],
          },
        }
      );
            ...
            columns: [
              {
                ...
                actions: [
                  { label: 'Go to line.me', type: 'uri', uri: 'https://line.me/ti/p/~api_2001' },
                  { label: 'Say message', type: 'postback', data: 'hello こんにちは' },
                ],
              },
              {
                thumbnailImageUrl: buttonsImageURL,
