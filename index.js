        ...
        replyToken,
        {
          ...
          template: {
            ...
            actions: [
              ...
              { lable: 'Help carousel', type: 'message', text: '!carousel' },
              { lable: 'Creator Template', type: 'message', text: 'Creator By Magicavi' },
            ],
          },
        }
      );
      ...
      return client.replyMessage(
        replyToken,
        {
          ...
          template: {
            type: 'buttons',
            thumbnailImageUrl: buttonsImageURL,
            title: 'คำสั่ง Template',
            text: '!Help!',
            actions: [
              { label: 'Add Friend Me', type: 'uri', uri: 'https://line.me/ti/p/~api_2001' },
              { label: 'Template สวัสดี', type: 'postback', data: 'สวัสดี ยินดี รับใช้ครับ' },
              { label: 'Help', type: 'postback', data: 'Template help' },
              { label: 'Creator', type: 'message', text: 'Creator Template' },
            ],
          },
        }
      );      
